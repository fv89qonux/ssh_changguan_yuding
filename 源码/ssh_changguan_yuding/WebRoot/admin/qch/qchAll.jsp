...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
            ...
            function queding()
            {
                 ...
                 var object=document.getElementsByName("qch_id");//返回的obeject是数组
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#86C1FF" align="center" style="margin-top:8px">
				<tr bgcolor="#c0ebf3">
					<td height="14" colspan="4" background="<%=path %>/images/tbg.gif">&nbsp;球馆选择&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<input type="radio" name="qch_id" value="<s:property value="#qch.id"/>"/>
					</td>
				</tr>
				</s:iterator>
			</table>
